...
export function DeletePost({ postId, postTitle, onDelete, disabled = false }: DeletePostProps) {
  ...
  return (
    <div 
      className="p-4 bg-zinc-900 dark:bg-zinc-800 rounded-xl border border-zinc-800 dark:border-zinc-700 shadow-2xl absolute bottom-full right-0 mb-4 w-64 z-50 transform origin-bottom transition-all duration-300 animate-in fade-in zoom-in slide-in-from-bottom-2"
